# Contributing to movepub

This outlines how to propose a change to movepub. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("inbo/movepub", fork = TRUE)`.
...
Please note that the movepub project is released with a [Contributor
Code of Conduct](https://inbo.github.io/movepub/CODE_OF_CONDUCT.md). By
