...
#> Downloading file from
#> 'https://zenodo.org/records/10053903/files/O_ASSEN-gps-2018.csv.gz'.
#> Downloading file from
#> 'https://zenodo.org/records/10053903/files/O_ASSEN-gps-2019.csv.gz'.
```
...
eml
#> $packageId
#> [1] "887a1eae-fc0b-4878-a90f-af57766557b8"
#> 
#> $system
#> [1] "uuid"
#> 
...
#> [1] "Data have been standardized to Darwin Core using the <ulink url=\"https://inbo.github.io/movepub/\"><citetitle>movepub</citetitle></ulink> R package and are subsampled to the first GPS position per hour. The original data are available in Dijkstra et al. (2023, <ulink url=\"https://doi.org/10.5281/zenodo.10053903\"><citetitle>https://doi.org/10.5281/zenodo.10053903</citetitle></ulink>), a deposit of Movebank study <ulink url=\"https://www.movebank.org/cms/webapp?gwt_fragment=page=studies,path=study1605797471\"><citetitle>1605797471</citetitle></ulink>."
```
