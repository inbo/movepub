...
`write_dwc()` requires the dataset to be structured as a [Data Package][fdp] (recognizable by the presence of a `datapackage.json` file). That is the case for O_ASSEN on Zenodo. See the previous section to create your own Data Package.
